...
SECRET_KEY = 'y6j&o1hbn^au=cx(n1#5!t+g7k+1!q6me!zwc=oa(+*ye%)r$0'
...
STATIC_URL = '/stat# Create your models here.ic/'
...
# JWT的配置项
JWT_AUTH = {
    # 设置jwt过期时长为1天，也可以是天为单位：hours
    'JWT_EXPIRATION_DELTA': datetime.timedelta(days=1),
    # 给 JWT_RESPONSE_PAYLOAD_HANDLER 重新赋值
